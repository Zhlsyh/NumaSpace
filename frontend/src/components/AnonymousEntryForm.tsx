    ...
    >
      ...
      >
        ...
        <div className="w-full lg:w-[500px] xl:w-[540px] p-4 sm:p-8 lg:p-12 flex flex-col justify-center">
          ...
          <form id="entry-form" onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-5">
        ...
        <div className="flex-1 bg-indigo-50/60 p-5 sm:p-8 flex flex-col justify-between relative min-h-[500px] lg:min-h-[600px] border-t lg:border-t-0 lg:border-l border-indigo-100">
          ...
          <div className="flex flex-col items-center justify-center my-auto space-y-4 w-full">
            ...
            <div className="relative w-full max-w-sm group">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="relative w-full py-4 sm:py-5 px-6 rounded-2xl sm:rounded-3xl bg-indigo-600 hover:bg-indigo-700 text-white font-black shadow-xl shadow-indigo-300/40 transition-all cursor-pointer flex flex-col items-center justify-center gap-1.5 border border-indigo-400/30"
              >
