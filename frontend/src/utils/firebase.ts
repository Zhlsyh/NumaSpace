...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || 'numaspace-demo.firebaseapp.com',
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || 'numaspace-demo',
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || 'numaspace-demo.appspot.com',
